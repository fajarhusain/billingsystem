...
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-{{ isset($customer) ? 'warning' : 'primary' }} text-white py-3">
        ...
        <div class="card-body">
            <form action="{{ isset($customer) ? route('customers.update', $customer->id) : route('customers.store') }}"
                ...
                <div class="form-group text-right">
                    <a href="{{ route('customers.index') }}" class="btn btn-secondary btn-sm mr-2">
                        <i class="fas fa-arrow-left mr-1"></i> Kembali
                    </a>
                    <button type="submit" class="btn btn-{{ isset($customer) ? 'warning' : 'primary' }} btn-sm">
